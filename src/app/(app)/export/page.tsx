...
export default function ExportPage() {
    ...
    const mapDataForExport = (rows: Good[]) => {
       return rows.map((item) => ({
            ...
            'Invoice Date': item.invoiceDate?.toDate ? format(item.invoiceDate.toDate(), 'dd/MM/yyyy') : '',
            'Model': item.model,
            'Type': item.type,
            ...
            'Date Added': item.createdAt?.toDate ? format(item.createdAt.toDate(), 'dd/MM/yyyy') : '',
        }));
    }
    ...
    return (
        <div className="space-y-6">
            <div className="space-y-1">
                ...
                <p className="text-muted-foreground">Filter inventory by model and export the data.</p>
            </div>

            <Card>
                <CardHeader>
                    <CardTitle>Filter by Model</CardTitle>
                    <CardDescription>Select a model to view and export the corresponding inventory items.</CardDescription>
                </CardHeader>
